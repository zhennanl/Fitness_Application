...
public class Proposaljframe extends JFrame {
	...
	public Proposaljframe(){
        ...
        for (food fod : Mainjframe.list_food){
        	...
        	if (type.containsKey(fod.getType())){
        		type.get(fod.getType()).add(fod.getName());
        	}else{
        		List<String> list = new ArrayList<String>();
        		list.add(fod.getName());
        		type.put(fod.getType(),list);
        	}
        }
        ...
        JButton btn1 = new JButton("Generate Suggestion");
        ...
        btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (food fod : Mainjframe.list_food){
					if(combox.getSelectedItem().toString().equals(fod.getType())&&combox_name.getSelectedItem().toString().equals(fod.getName())){
						record rec = new record(Mainjframe.year, Mainjframe.mouth, Mainjframe.date, 1, fod.getType(), fod.getName(), Integer.parseInt(txt1.getText()), fod.getKcal());
						jdbc_record.add(Mainjframe.year, Mainjframe.mouth, Mainjframe.date, 1, fod.getType(), fod.getName(), txt1.getText(), fod.getKcal());
						Mainjframe.list_rec.add(rec);
						Mainjframe.update_fod();
					}
				}
